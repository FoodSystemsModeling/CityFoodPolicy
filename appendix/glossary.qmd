...
-   [Food Policy Actions](#glossary-food-policy-actions)
    -   [Business as Usual](#glossary-business-as-usual)
    -   [Environmental Sustainability: Organic Purchasing](#glossary-organic)
    -   [Local Economies: M/WBE Purchasing](#glossary-MWBE)
    -   [Local Economies: Local Purchasing](#glossary-local)
    -   [Local Economies: Community Hiring from Small Producers](#glossary-community-hiring)
    -   [Local Economies: Investment in Middle Supply Chain Infrastructure](#glossary-infrastructure)
    -   [Nutrition: Menu Changes](#glossary-menu)
-   [Supply Chain Diagram](#glossary-supply-chain)
    -   [Supply Chain participant types](#glossary-supply-chain-participants)
    -   [Supply Chain Map](#glossary-supply-chain-map)
    -   [Supply Chain with Policy Contracts](#glossary-supply-chain-policy-contracts)
-   [Modeled Impacts by Food Policy Action, Definition, and Implementation Scenario](#glossary-modeled-impacts)
    -   [Overall Impact](#glossary-overall-impact)
    -   [NYC Agency Impact](#glossary-nyc-agency-impact)
    -   [Producer Impact](#glossary-producer-impact)
    -   [Economic Impact](#glossary-economic-impact)
...
In the model, each participant represents a type of food system actor—such as farms, food businesses, or City agencies—with distinct roles, constraints, decision rules, and characteristics. We refer to these collectively as supply chain participants, each with specific attributes that shape how they operate within the system. For example, a farm may have one or more of the following characteristics: small-scale, certified organic, or owned/operated by M/WBE producers.
...
##### Out-of-State-Supply
Out-of-state supply represents products and inputs sourced from outside New York State that influence market conditions, pricing, and procurement outcomes in the model.

##### Bean Pathway
This pathway illustrates how beans move through the modeled supply chain from Producers through intermediary businesses to end buyers, including NYC Agencies and other markets.

##### Contract Information Pathway
This pathway illustrates how information about procurement contract opportunities flows through the supply chain, beginning with NYC Agencies. It shows how supply chain participants learn about the food products NYC intends to purchase, including product form (e.g., dried, canned, processed) and specific attributes (e.g., organic, M/WBE).

#### Supply Chain Map {#glossary-supply-chain-map}
The Supply Chain Map shows the number, types, characteristics and locations of supply chain participants in New York State. Data on supply chain Participants comes from multiple sources; additional details are available on our GitHub site. Locations shown on the map represent randomly generated points within the counties where participants are located and are intended to illustrate geographic distribution rather than exact addresses.
...
Producers that have certified organic acres according to the 2022 U.S. Census of Agriculture.  

##### Local
A supply chain participant is considered local if it is in New York State. However, the mix of supply chain  participants, or portion of the raw product that must be “local” differ based on the selected definition. 
...
#### Environmental Impact {#glossary-environmental-impact}
